	...
	execute(req, function(res){ 
		response_to_json(res, function(result){
			...
			else
			{
				...
				for (var propertyName in result.content['m:properties'])
				{
					if (propertyName == "d:Timestamp")
					{
						entity[propertyName.replace("d:", "")] = result.content['m:properties'][propertyName]['#'];
					}
					else
					{
						entity[propertyName.replace("d:", "")] = result.content['m:properties'][propertyName];
