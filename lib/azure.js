...
var fs = require('fs');
var xml2js = require('D:/code/node-libs/node-xml2js');
...
exports.show_response = show_response;

function xml_body (res , cb) {
...
exports.xml_body = xml_body;

function raw_body (res , cb) {
...
function list_containers (account, cb) {
  
	var req = {
		url: account.blob_storage_url + '/?comp=list',
		method: 'GET'
	};
...
function create_container (account, container_name, cb) {
  
	var req = {
		url: account.blob_storage_url + '/' + container_name + '?restype=container',
		method: 'PUT'
	};
...
function get_container_properties (account, container_name, cb) {
...
exports.get_container_properties = get_container_properties;

function get_container_metadata (account, container_name, cb) {
  
	var req = {
		url: account.blob_storage_url + '/' + container_name + '?comp=metadata&restype=container',
		method: 'HEAD'
	};
...
exports.get_container_metadata = get_container_metadata;

function set_container_metadata(account, container_name, meta, cb) {
...
exports.set_container_metadata = set_container_metadata

// TODO Get Container ACL
// TODO Set Container ACL

function delete_container(account, container_name, cb) {
...
function list_blobs (account, container_name, cb) {
  
	var req = {
		url: account.blob_storage_url + '/' + container_name + '?comp=list&restype=container',
		method: 'GET'
        };
...
exports.list_blobs = list_blobs;

exports.BlockBlob = "BlockBlob";
exports.PageBlob = "PageBlob";

function put_blob (account, container_name, blob_type, blob_name, content, cb) {

	// TODO support Content-Type, Content-Encoding, Content-Language
  
	var req = {
		url: account.blob_storage_url + '/' + container_name + '/' + blob_name,
		method: 'PUT',
		x_ms_blob_type: blob_type,
		body: content
        };
...
exports.put_blob = put_blob;

function get_blob (account, container_name, blob_name, cb) {
...
function delete_blob(account, container_name, blob_name, cb) {
...
exports.delete_blob = delete_blob;
...
function download_blob (account, container_name, blob_name, file_name, cb) {
...
exports.download_blob = download_blob;
...
function query_tables (account, cb) {
...
exports.query_tables = query_tables;

function create_table (account, table_name, cb) {
